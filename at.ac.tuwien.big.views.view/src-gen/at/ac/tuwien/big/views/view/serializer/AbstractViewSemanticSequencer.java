...
public abstract class AbstractViewSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ViewsPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case ViewsPackage.SELECTION_ITEM:
				sequence_SelectionItem_Impl(context, (SelectionItem) semanticObject); 
				return; 
	...
	/**
	 * Constraint:
	 *     (elementID=QualifiedName label=STRING property=[Property|QualifiedName] condition=Condition?)
	 */
	...
	protected void sequence_ComparisonCondition(EObject context, ComparisonCondition semanticObject) {
		...
		feeder.accept(grammarAccess.getComparisonConditionAccess().getConditionIDQualifiedNameParserRuleCall_1_0(), semanticObject.getConditionID());
		feeder.accept(grammarAccess.getComparisonConditionAccess().getPropertyPropertyElementQualifiedNameParserRuleCall_3_0_1(), semanticObject.getProperty());
	...
	/**
	 * Constraint:
	 *     (elementID=QualifiedName label=STRING format=STRING? property=[Property|QualifiedName] condition=Condition?)
	 */
	 ...
	 *     value=STRING
	 */
	protected void sequence_SelectionItem_Impl(EObject context, SelectionItem semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ViewsPackage.Literals.SELECTION_ITEM__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ViewsPackage.Literals.SELECTION_ITEM__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getSelectionItem_ImplAccess().getValueSTRINGTerminalRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (welcomeViewGroup?='welcome'? name=QualifiedName (views+=View views+=View*)?)
	 */
